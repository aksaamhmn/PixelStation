            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="adminDashboard.php">Pixel Station</a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item <?php echo ($currentPage == 'adminDashboard.php') ? 'active' : ''; ?>">
                        ...
                        <li class="sidebar-item <?php echo ($currentPage == 'dataReservasi.php') ? 'active' : ''; ?>">
                            <a href="dataReservasi.php" class='sidebar-link'>
                                <i class="bi bi-basket3-fill"></i>
                                <span>Reservation</span>
                            </a>
                        </li>
                        <li class="sidebar-item <?php echo ($currentPage == 'dataReview.php') ? 'active' : ''; ?>">
                            <a href="dataReview.php" class='sidebar-link'>
                                <i class="bi bi-star-fill"></i>
                                <span>Review</span>
                            </a>
                        </li>
                        <li class="sidebar-item <?php echo ($currentPage == 'adminLogout.php') ? 'active' : ''; ?> position-absolute bottom-0 w-100 mb-4">
                            <a href="adminLogout.php" class='sidebar-link text-danger'>
