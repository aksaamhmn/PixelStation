    ...
    <div class="container">
        <div class="footer-row" style="display: flex; justify-content: space-between; align-items: flex-start;">
            ...
            <div class="footer-col" style="flex:1; padding:0 15px; border-left:1px solid rgba(255,255,255,0.2);">
                ...
                <div>
                    <a href="#" style="color:#fff; margin-right:12px;"><i class="bi bi-facebook"></i></a>
                    <a href="#" style="color:#fff; margin-right:12px;"><i class="bi bi-twitter"></i></a>
                    <a href="#" style="color:#fff;"><i class="bi bi-instagram"></i></a>
                </div>
            </div>
        </div>
        <hr class="border-secondary my-4" style="border-color:rgba(255,255,255,0.2)!important;">
        <div class="text-center small" style="color:#fff;">
            &copy; 2025 Pixel Station. All rights reserved.
        </div>
    </div>
</footer>
